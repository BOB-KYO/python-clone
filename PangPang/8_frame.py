...
# 2.사용자 게임 초기화 (배경화면, 게임 이미지, 좌표, 폰트, 속도 등등)
...
while running:
    ...
    #이벤트 루프 처리 for문 (키보드, 방향키 등등)
    for event in pygame.event.get():
        if event.type == pygame.QUIT: # panal have a X button.  창이 닫히는 이벤트가 발생하게 설정
